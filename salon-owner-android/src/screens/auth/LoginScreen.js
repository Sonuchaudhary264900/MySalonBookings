...
export default function LoginScreen({ navigation }) {
  ...
  // Auto-submit the instant the 6th digit lands — whether typed, pasted, or
  // filled by the OS SMS/Autofill suggestion — so the user never has to tap
  // Sign In themselves. Resets whenever the code is incomplete again so a
  // corrected retry after a failed attempt still auto-submits.
  useEffect(() => {
