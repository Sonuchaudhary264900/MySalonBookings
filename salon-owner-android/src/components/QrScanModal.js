    ...
    <Modal visible={visible} animationType="slide" onRequestClose={onClose}>
      <View style={[styles.container, { backgroundColor: theme.bg }]}>
        <View style={[styles.header, { borderBottomColor: theme.border }]}>
          <Ionicons name="scan-outline" size={16} color="#7c3aed" style={{ marginRight: 8 }} />
          <Text style={[styles.title, { color: theme.text }]}>Scan UPI QR</Text>
...
const styles = StyleSheet.create({
  ...
  frame:     { width: 230, height: 230, borderWidth: 2.5, borderColor: 'rgba(124,58,237,0.9)', borderRadius: 18 },
  center:    { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 24, gap: 12 },
  permText:  { fontSize: 13, textAlign: 'center', lineHeight: 20 },
  permBtn:   { marginTop: 4, paddingHorizontal: 20, paddingVertical: 12, borderRadius: 12, backgroundColor: '#7c3aed' },
