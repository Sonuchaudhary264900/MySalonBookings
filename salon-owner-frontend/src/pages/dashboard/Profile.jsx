      ...
      <div className="max-w-2xl space-y-4">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-5 flex items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            {(() => {
              const typeDef = SALON_TYPES.find(t => t.key === salon?.salonType || salon?.businessType);
              return typeDef ? (
          ...
          {!isEditing ? (
            <div className="space-y-3 pt-2">
              {[
                ...
                (() => { const td = SALON_TYPES.find(t => t.key === salon?.salonType || salon?.businessType); return td ? { icon: Sparkles, color: 'text-indigo-500', label: 'Business Type', value: td.label } : null; })(),
        ...
        >
          <div className="space-y-3 pt-2">
            {[
              ...
              { label: 'Account Type',  value: (() => { const td = SALON_TYPES.find(t => t.key === salon?.salonType || salon?.businessType); return td ? `${td.label} Owner` : 'Salon Owner'; })() },
