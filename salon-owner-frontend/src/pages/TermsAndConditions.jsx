...
const SECTIONS = [
  {
    ...
    body: [
      'By registering as a salon owner on MySalonBookings ("Platform"), you agree to be bound by these Terms & Conditions and our Privacy Policy.',
  ...
  },
  {
    ...
    body: [
      ...
      'MySalonBookings reserves the right to remove or suspend any salon listing that violates these terms or applicable laws.',
    ],
  },
  {
    title: '4. Bookings & Customer Obligations',
    body: [
      'When a customer books through the platform, you are entering a direct service agreement with that customer. MySalonBookings is not a party to that agreement.',
  ...
  },
  {
    ...
    body: [
      ...
      'MySalonBookings is not responsible for payment disputes between you and customers.',
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      'By uploading photos, descriptions, or other content, you grant MySalonBookings a non-exclusive, royalty-free licence to display and promote that content on our platform.',
      'You must only upload content that you own or have the right to use. Do not upload copyrighted material without permission.',
      'MySalonBookings\'s logo, branding, and platform code are our exclusive intellectual property and may not be reproduced without written consent.',
    ],
  },
  {
    title: '8. Prohibited Conduct',
    body: [
      'You must not use the platform for any unlawful activity or in a way that harms other users, customers, or MySalonBookings.',
  ...
  },
  {
    ...
    body: [
      ...
      'You may close your account at any time by contacting support@mysalonbookings.com.',
  ...
  },
  {
    ...
    body: [
      'MySalonBookings provides the platform "as is" and makes no guarantees regarding uptime, customer volume, or revenue outcomes.',
      'We are not liable for any indirect, incidental, or consequential losses arising from your use of the platform.',
      'Our total liability for any claim shall not exceed the amount you paid to MySalonBookings in the three months preceding the claim.',
    ],
  },
  {
      ...
      <div className="max-w-3xl mx-auto px-4 py-12 space-y-8">
        <div className="bg-white rounded-2xl border border-slate-100 p-6 shadow-sm">
          <p className="text-slate-600 text-sm leading-relaxed">
            Welcome to the MySalonBookings Owner Platform. These Terms &amp; Conditions govern your registration and use of the
